...
# It's time to practice adding buttons to your interactive visualizations. Your job in this exercise is to create a
# button and use its on_click() method to update a plot.

# All necessary modules have been imported for you. In addition, the ColumnDataSource with data x and y as well as the
# figure have been created for you and are available in the workspace as source and plot.

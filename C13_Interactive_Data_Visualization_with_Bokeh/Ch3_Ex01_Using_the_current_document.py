...
# layouts that you create. Your job in this exercise is to use this function to add a single plot to your application.

# In the video, Bryan described the process for running a Bokeh app using the bokeh serve command line tool. In this
# chapter and the one that follows, the DataCamp environment does this for you behind the scenes. Notice that your code
# is part of a script.py file. When you hit 'Submit Answer', you'll see in the IPython Shell that we call bokeh serve
# script.py for you.
...
# - Add the plot to the current document using curdoc().add_root(). It needs to be passed in as an argument to
# add_root().

...
# In this exercise, you're going to create two plots from the Literacy and Birth Rate data set to plot fertility vs
# female literacy and population vs female literacy.
...
# In this exercise, you may have to scroll sideways to view both figures in the row layout. Alternatively, you can view
# the figures in a new window by clicking on the expand icon to the right of the "Bokeh plot" tab.
...
# - Add a circle glyph to p1. The x-axis data is fertility and y-axis data is female_literacy. Be sure to also specify
# source=source.

...
# In this exercise, you'll practice adding a hover tool to drill down into data column values and display more
# detailed information about each scatter point.

# After you're done, experiment with the hover tool and see how it displays the name of the country when your mouse
# hovers over a point!

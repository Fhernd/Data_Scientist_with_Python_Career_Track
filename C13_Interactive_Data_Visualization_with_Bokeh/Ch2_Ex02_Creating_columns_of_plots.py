...
# In this exercise, you're going to use the column() function to create a single column layout of the two plots you
...
# - The figure p1 has been created for you. Create a new figure p2 with an x-axis label of 'population' and y-axis
# label of 'female_literacy (% population)'.

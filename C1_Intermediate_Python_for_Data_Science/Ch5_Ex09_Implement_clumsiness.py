...
# With this neatly written code of yours, changing the number of times the random walk should be simulated is
# super-easy. You simply update the range() function in the top-level for loop.

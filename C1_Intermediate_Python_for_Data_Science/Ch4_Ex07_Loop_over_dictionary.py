...
# Write a for loop that goes through each key:value pair of europe. On each iteration, "the capital of x is y" should
# be printed out, where x is the key and y is the value of the pair.

...
# If you are interested in learning how to access Twitter data so you can work with it on your own system, refer to
# Part 2 of the DataCamp course on Importing Data in Python.

# The pandas package has been imported as pd and the file 'tweets.csv' is in your current directory for your use. Go
# for it!
...
# - Iterate over the 'tweets.csv' file by using a for loop. Use the loop variable chunk and iterate over the call to
# pd.read_csv() with a chunksize of 10.
...
for chunk in pd.read_csv(filepath_or_buffer='tweets.csv', chunksize=10):

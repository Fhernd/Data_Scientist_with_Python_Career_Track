...
# In this case, it would be useful to use generators. Generators allow users to lazily evaluate data. This concept
# of lazy evaluation is useful when you have to deal with very large datasets because it lets you generate values in
# an efficient manner by yielding only chunks of data at a time instead of the whole thing at once.
...
# - In the function read_large_file(), read a line from file_object by using the method readline(). Assign the
# result to data.

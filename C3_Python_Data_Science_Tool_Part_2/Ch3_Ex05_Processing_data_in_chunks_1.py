...
# to this file using what is known as a context manager. For example, the command with open('datacamp.csv') as
# datacamp binds the csv file 'datacamp.csv' as datacamp in the context manager. Here, the with statement is the
# context manager, and its purpose is to ensure that resources are efficiently allocated when opening a connection
# to a file.
...
# - Complete the for loop so that it iterates 1000 times to perform the loop body and process only the first 1000
# rows of data of the file.

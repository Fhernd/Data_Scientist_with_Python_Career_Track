...
# omprehension to generate a list of dictionaries. That was a lot of work and you did a great job!
...
# - Create a DataFrame from the list of dictionaries in list_of_dicts by calling pd.DataFrame(). Assign the

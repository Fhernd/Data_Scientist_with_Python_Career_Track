...
# bit of background on the Chinook database: the Chinook database contains information about a semi-fictional digital
# media store in which media data is real and customer, employee and sales data has been manually created.

# Why the name Chinook, you ask? According to their website,

# The name of this sample database was based on the Northwind database. Chinooks are winds in the interior West of
# North America, where the Canadian Prairies and Great Plains meet various mountain ranges. Chinooks are most
# prevalent over southern Alberta in Canada. Chinook is a good name choice for a database that intends to be an
# alternative to Northwind.

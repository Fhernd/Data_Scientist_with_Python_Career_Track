...
# Initially, fractions_change is a wide DataFrame of 26 rows (one for each Olympic edition) and 139 columns (one for
# the edition and 138 for the competing countries).
...
# ('NOC') is 'CHN'.
# - Print the last 5 rows of the DataFrame chn using the .tail() method. This has been done for you, so hit

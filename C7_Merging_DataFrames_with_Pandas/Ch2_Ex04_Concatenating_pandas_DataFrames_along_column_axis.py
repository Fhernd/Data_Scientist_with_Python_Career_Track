...
# DataFrame, null values are inserted in the concatenated DataFrame. This corresponds to an outer join (which you will
# explore in more detail in later exercises).

# The files 'quarterly_max_temp.csv' and 'monthly_mean_temp.csv' have been pre-loaded into the DataFrames weather_max
# and weather_mean respectively, and pandas has been imported as pd.

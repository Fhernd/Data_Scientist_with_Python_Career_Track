...
# - Make a new DataFrame china_annual by resampling the DataFrame china with .resample('A') (i.e., with annual
# frequency) and chaining two method calls:
...
# - Print the result of resampling gdp every decade (i.e., using .resample('10A')) and aggregating with the method
# .last(). This has been done for you, so hit 'Submit Answer' to see the result!

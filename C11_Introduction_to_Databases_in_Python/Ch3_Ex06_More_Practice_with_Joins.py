...
# You can use the same select statement you built in the last exercise, however, let's add a twist and only return a
# few columns and use the other table in a group_by() clause.

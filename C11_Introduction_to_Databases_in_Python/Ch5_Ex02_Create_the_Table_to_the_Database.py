...
# Having setup the engine and initialized the metadata, you will now define the census table object and then create
# it in the database using the metadata and engine from the previous exercise. To create it in the database,
# you will have to use the .create_all() method on the metadata with engine as the argument.

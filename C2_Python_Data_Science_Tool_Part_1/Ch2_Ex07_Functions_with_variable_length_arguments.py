...
# Flexible arguments enable you to pass a variable number of arguments to a function. In this exercise, you will
# practice defining a function that accepts a variable number of string arguments.
...
# call using more than one string argument. Recall from the previous video that, within the function definition, args
# is a tuple.

...
# 'Borough' column. The pandas .boxplot() method is a quick way to do this, in which you have to specify the column and
# by parameters. Here, you want to visualize how 'initial_cost' varies by 'Borough'.

# pandas and matplotlib.pyplot have been imported for you as pd and plt, respectively, and the DataFrame has been
# pre-loaded as df.

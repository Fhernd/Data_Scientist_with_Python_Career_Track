...
# where M×N is the dimensions of the image. The third dimensions are referred to as color channels (typically red,
# green, and blue).
# - The color channels can be extracted by Numpy array slicing.

# In this exercise, you will load & display an image of an astronaut (by NASA (Public domain), via Wikimedia Commons).
# You will also examine its attributes to understand how color images are represented.

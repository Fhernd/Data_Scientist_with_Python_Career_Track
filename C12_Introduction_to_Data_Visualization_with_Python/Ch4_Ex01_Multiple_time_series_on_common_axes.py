...
# For this exercise, you will construct a plot showing four time series stocks on the same axes. The time series in
# question are represented in the session using the identifiers aapl, ibm, csco, and msft. You'll generate a single
# plot showing all the time series on common axes with a legend.

...
# Seaborn's sns.jointplot() provides means of visualizing bivariate distributions. The basic calling syntax is similar
# to that of sns.lmplot(). By default, calling sns.jointplot(x, y, data) renders a few things:
...
# - Use sns.jointplot() to visualize the joint variation of the columns 'hp' (on the x-axis) and 'mpg' (on the y-axis)
# from the DataFrame auto.

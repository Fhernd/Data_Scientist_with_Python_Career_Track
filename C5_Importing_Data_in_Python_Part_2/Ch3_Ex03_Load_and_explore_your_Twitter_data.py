...
# - Within the for loop initiated by for line in tweets_file:, load each tweet into a variable, tweet, using
# json.loads(), then append tweet to tweets_data using the append() method.

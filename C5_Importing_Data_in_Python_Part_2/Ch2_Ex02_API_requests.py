...
# Now it's your turn to pull some movie data down from the Open Movie Database (OMDB) using their API. The movie you'll
# query the API about is The Social Network. Recall that, in the video, to query the API about the movie Hackers,
...
# corresponding to the movie The Social Network. The query string should have two arguments: apikey=72bc447a
# and t=the+social+network. You can combine them as follows: apikey=72bc447a&t=the+social+network.

...
# - Load the JSON 'a_movie.json' into the variable json_data within the context provided by the with statement. To do
# so, use the function json.load() within the context manager.
